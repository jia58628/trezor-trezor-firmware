...
class ZcashV4(Bitcoinlike):
    ...
    async def step7_finish(self) -> None:
        ...
        write_uint64(self_serialized_tx, 0)  # valueBalance
        write_compact_size(self_serialized_tx, 0)  # nShieldedSpend
        write_compact_size(self_serialized_tx, 0)  # nShieldedOutput
        write_compact_size(self_serialized_tx, 0)  # nJoinSplit

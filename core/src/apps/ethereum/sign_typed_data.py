        ...
        for member_index, member in enumerate(type_members):
            ...
            if field_type.data_type == EthereumDataType.STRUCT:
                ...
                if field_type.size is None:
                    array_size = await _get_array_size(self_ctx, member_value_path)
                else:
                ...
                for i in range(array_size):
                    ...
                    if entry_type.data_type == EthereumDataType.STRUCT:
                        ...
                        value = await get_value(self_ctx, entry_type, el_member_path)
                ...
                value = await get_value(self_ctx, field_type, member_value_path)

...
async def handle_erc20(
    ...
    if (
        ...
        and len(msg_data_initial_chunk) == 68
        and msg_data_initial_chunk[:16]
        ...
        recipient = msg_data_initial_chunk[16:36]
        value = int.from_bytes(msg_data_initial_chunk[36:68], "big")
